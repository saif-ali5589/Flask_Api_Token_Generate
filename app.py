...
def create_author(current_user):
    ...
    new_authors = Authors(name=data['name'], country=data['country'], book=data['book'], booker_prize=True, id=current_user.id)
...
def get_authors(current_user):
    authors = Authors.query.filter_by(id=current_user.id).all()
